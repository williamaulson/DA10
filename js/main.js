window.onload = function() {
    ...
    var avatarLife = 100;
    var enemyLife = 100;
    var textStyle = { font: "20px Arial", fill: "#65F200", align: "center" };
    var avatarText;
    var enemyText;
    ...
    function create() //create assets
    {
    	    ...
    	    startText = game.add.text(60, 55, 'Move: A, D, W\nShoot: Spacebar\nFire: M', startTextStyle);
    	    startText2 = game.add.text(650, 105, 'Enemy AI\nand game\nis a WIP.', startTextStyle);
    ...
    function update() //run game logic
    {
    	    ...
    	    if ((avatarLife < 1) && (gameEnd === false)) //endgame check
    	    {
    	    	    ...
    	    	    game.add.text(260, 150, 'You have been destroyed.\n\nTough break.', startTextStyle);
    	    }
    	    else if ((enemyLife < 1) && (gameEnd === false))
    	    {
    	    	    ...
    	    	    death.play('', .5, 2, false);
    	    	    game.add.sprite(0, 0, 'splash');
    	    	    game.add.text(410, 150, 'You Win!\n\nVictory!', startTextStyle);
    	    }
    	    ...
    	    if (gameRunning) //game actually running
    	    {
    	    	    ...
    	    	    avatarText.setText('Player: ' + avatarLife);
    	    	    enemyText.setText('Boss: ' + enemyLife);
    	    	   ...
    	    	   // }
    	    	    ...
    	    	    game.physics.arcade.overlap(avatar, enemyShotGroup, null, damageAvatar, this);
    	    	    game.physics.arcade.overlap(avatar, enemyFireShotGroup, null, fireDamageAvatar, this);
    	    	    game.physics.arcade.overlap(avatar, enemySnipeGroup, null, snipeDamageAvatar, this);
    	    	    game.physics.arcade.overlap(enemy, avatarShotGroup, null, damageEnemy, this);
    	    	    game.physics.arcade.overlap(enemy, avatarFireShotGroup, null, fireDamageEnemy, this);
    ...
    function airEnd()
    {
    	    ...
    	    {
    	    	    console.log('airend');
    	    	    //game.time.events.add(Phaser.Timer.SECOND * 1.50, resetNotInScript, null);
    	    	    notInScript = 1;
    	    	    enemy.body.velocity.x = 0;   
    	    }
    }
    
    function resetNotInScript()
    {
    	    notInScript = 1;
    	    //inGroundAttack = 0;
    }
    ...
    function script41()
    {
    	    ...
    	    if (game.rnd.integerInRange(1, 9) < 4)
    	    {
    	    	    //shoot.play('', .6, 1, false);
    	    	    snipeShootCount = 1;
    	    	    game.time.events.add(Phaser.Timer.SECOND * .50, readySnipeShoot, null);  
    	    }
    	    else
    	    {
    	    	    //arc shot
    ...
    function script42()
    {
    	    ...
    	    if (game.rnd.integerInRange(1, 9) < 6)
    	    {
    	    	   ...
    	    	   //game.time.events.add(Phaser.Timer.SECOND * .50, flip, null);
    	    	   regularShootCount = 3;
    	    	   game.time.events.add(Phaser.Timer.SECOND * .30, readyRegShoot, null);
    	    	   //fire script
    	    }
    	    else
    	    {
    ...
    function snipeDamageAvatar(avatar, snipeShot)
    {
    	    if (avatarLife > 10)
    	    {
